                ...
                <div class="container">
                    <div class="content-wrapper">
                        ...
                        <div class="company-info">
                            <li> <a href="#"
                                    class="info-email  link-underline cursor-link">vishalsathwarax99@gmail.com</a></li>
                            <br>
                            <li>
                            ...
                            <div class="info-address">
                                <li> <a href="#" class="info-email cursor-link">D-113 ParasParabhu Soc, Isanpur,
                                        Ahmedabad , India - 382443.</a></li>
            ...
            <div class="row no-gutters">
                ...
                <div class="gallery full-width">
                    ...
                    <div class="items web  animate__animated animate__fadeIn animate__slow" id="dance">
                        ...
                        <div style=" background:#2d2a2aa6; width:100%; padding:13px; font-size:2rem"
